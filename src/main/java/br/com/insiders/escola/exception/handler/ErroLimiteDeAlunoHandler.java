...
@ControllerAdvice
public class ErroLimiteDeAlunoHandler {

    @ExceptionHandler(LimiteDeAlunoPorTurma.class)
    public ResponseEntity<ErrorDto> limiteDeAlunoPorTurma(LimiteDeAlunoPorTurma e, HttpServletRequest request){
